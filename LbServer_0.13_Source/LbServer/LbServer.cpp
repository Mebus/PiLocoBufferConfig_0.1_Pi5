...
//             $Id: LbServer.cpp 1259 2023-02-26 11:06:38Z pischky $
//-------------------------------------------------------------------
...
static void Help(char* argv0)
{
	...
	printf("\n");
	printf("You have to configure your LocoBuffer hardware as follows:\n");
	printf("\n");
	printf("     JP1  2-3  57600 Baud\n");
	printf("     JP2  2-3  Echo On\n");
	printf("     JP3  2-3  LocoBuffer Mode\n");
	printf("\n");
...
void handleSigAbort( int sig ) {
	log_print_and_stderr( LOG_ERR, "Got signal SIGABRT(%i): '%s'. May be an "
	                      "assertion failed.", sig, sys_siglist[sig] );
...
int main(int argc, char* argv[])
{
	...
	try {
		...
		#endif
		printf("released under GPL by Stefan Bormann.  Linux port by Ian Cunningham.\n");
		#ifdef WITH_JOURNALD
			printf("\n");
