//-------------------------------------------------------------------
// File name   Model.cs
//             $Id: Model.cs 1328 2023-05-07 09:50:57Z pischky $
//-------------------------------------------------------------------
...
namespace net.sf.loconetovertcp.lbsrvcfg
{
    ...
    public class Model
    {
        ...
        /// <summary>
        /// Get current list of COM ports.
        /// May change when devices are plugged or unplugged.
        /// </summary>
        /// <returns>A List like ["COM1", "COM7"].</returns>
        /// <exception cref="System.Management.ManagementException">
        ///     Sometimes we get ManagementException when there are no COM 
        ///     ports on this system.
        /// </exception>
